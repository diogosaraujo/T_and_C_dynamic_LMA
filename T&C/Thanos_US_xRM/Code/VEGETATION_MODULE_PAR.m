    ...
    if ZR_H(cc) > 0
        ...
        elseif aSE_H(cc) == 5
            ...
            [hc_H(cc),SAI_H(cc),B_H(:,:),~,Nreserve_H(cc),Preserve_H(cc),Kreserve_H(cc),AgrHarNut(:)] = CropHeightType(LAI_H(cc),LAIdead_H(cc),cc,B_H(:,:),...
                Ccrown,Nreserve_H(cc),Preserve_H(cc),Kreserve_H(cc),Stoich_H(cc),ManIH,Mpar_H,VegH_Param_Dyn,OPT_SoilBiogeochemistry);
    ...
    if ZR_L(cc) > 0
        ...
        elseif aSE_L(cc) == 5
            ...
            [hc_L(cc),SAI_L(cc),B_L(:,:),~,Nreserve_L(cc),Preserve_L(cc),Kreserve_L(cc),AgrHarNut(:)] = CropHeightType(LAI_L(cc),LAIdead_L(cc),cc,B_L(:,:),...
                Ccrown,Nreserve_L(cc),Preserve_L(cc),Kreserve_L(cc),Stoich_L(cc),ManIL,Mpar_L,VegL_Param_Dyn,OPT_SoilBiogeochemistry);
